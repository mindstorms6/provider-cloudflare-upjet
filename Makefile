...
PROJECT_NAME ?= provider-cloudflare-upjet
PROJECT_REPO ?= github.com/mindstorms6/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cloudflare_v5.1.0
...
$(TERRAFORM_PROVIDER_SCHEMA): $(TERRAFORM)
	...
	@$(INFO) echo "Terrafor provider schema is at $(TERRAFORM_PROVIDER_SCHEMA)"
	@sed -i 's/"type":"dynamic"/"type":"string"/g' $(TERRAFORM_PROVIDER_SCHEMA)
