...
type TrustDeviceCustomProfileInitParameters struct {
	...
	// (Attributes List) (see below for nested schema)
	FallbackDomains []FallbackDomainsInitParameters `json:"fallbackDomains,omitempty" tf:"fallback_domains,omitempty"`
	...
	// (String) The wirefilter expression to match devices.
	...
	// (Attributes List) (see below for nested schema)
	TargetTests []TargetTestsInitParameters `json:"targetTests,omitempty" tf:"target_tests,omitempty"`
...
type TrustDeviceCustomProfileParameters struct {
	...
	// (Attributes List) (see below for nested schema)
	// +kubebuilder:validation:Optional
	FallbackDomains []FallbackDomainsParameters `json:"fallbackDomains,omitempty" tf:"fallback_domains,omitempty"`
	...
	// (Attributes List) (see below for nested schema)
	// +kubebuilder:validation:Optional
	TargetTests []TargetTestsParameters `json:"targetTests,omitempty" tf:"target_tests,omitempty"`
...
type TrustDeviceCustomProfile struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.targetTests) || (has(self.initProvider) && has(self.initProvider.targetTests))",message="spec.forProvider.targetTests is a required parameter"
