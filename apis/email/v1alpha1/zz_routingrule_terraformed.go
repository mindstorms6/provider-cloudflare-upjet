...
// GetInitParameters of this RoutingRule
func (tr *RoutingRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RoutingRule
func (tr *RoutingRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
